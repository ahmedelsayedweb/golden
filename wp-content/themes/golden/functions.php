...
function ahmed_add_styles() {
	...
	wp_enqueue_style('normalize', get_template_directory_uri() . '/assets/css/style.css');
	wp_enqueue_style('awesome', get_template_directory_uri() . '/assets/css/bootstrap.css');
	wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/css/responsive.css');
	wp_enqueue_style('animate', get_template_directory_uri() . '/assets/css/theme-color.css');
	wp_enqueue_style('responsive', get_template_directory_uri() . '/assets/css/owl.carousel.css');
...
function ahmed_add_scripts() {
	...
	wp_enqueue_script('custom', get_template_directory_uri() . '/assets/js/jquery-1.11.3.min.js', array() , false, true);
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array() , false, true);
	wp_enqueue_script('wow', get_template_directory_uri() . '/assets/js/migrate.js', array() , false, true);
	wp_enqueue_script('magnific', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array() , false, true);
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/js/imagesloaded.pkgd.js', array() , false, true);
	wp_enqueue_script('doubletaptogo', get_template_directory_uri() . '/assets/js/custom.js', array() , false, true);
